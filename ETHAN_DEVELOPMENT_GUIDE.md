...
│   ├── run_echo.py     # Main server entry point
│   ├── text_chat.py    # Text chat backend
│   ├── image_chat.py   # Image chat backend
│   └── ...
├── static/             # Frontend files
│   ├── styles.css      # Main stylesheet (beautiful design!)
│   ├── nlip.js         # NLIP client library
│   ├── page1_text_chat.html      # Text-only chat
│   ├── page2_structured_chat.html # Structured data chat
│   ├── page3_text_image_chat.html # Image chat
│   ├── page4_multimedia_chat.html # Multimedia chat
│   └── ...
